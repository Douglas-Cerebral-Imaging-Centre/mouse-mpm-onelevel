...
tail -n +2 "bids_conversion/scan_indices.csv" | while IFS=',' read -r sourcedata_folder subject_id session_id structural_scanidx mpm_pdw_scanidx mpm_mtw_scanidx mpm_t1w_scanidx flip1_TB1DAM_scanidx flip2_TB1DAM_scanidx; do
