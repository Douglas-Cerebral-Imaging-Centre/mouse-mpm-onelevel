...
for i_subject in ../rawdata/sub-*/; do
  ...
  for i_session in ${i_subject}*/; do
      ...
      ../rawdata/${i_subject_id}/${i_session_id}/fmap/${i_subject_id}_${i_session_id}_flip-1_TB1DAM.nii.gz \
      ../rawdata/${i_subject_id}/${i_session_id}/fmap/${i_subject_id}_${i_session_id}_flip-2_TB1DAM.nii.gz \
